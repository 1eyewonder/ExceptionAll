...
{
    public class ForbiddenDetailsTests : TestBase
    {
        private const string Title = "Forbidden";
        private const string Message = "Test Message";
        private readonly List<ErrorDetail> _errorDetails = new();

        public ForbiddenDetailsTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public void ActionContextConstructor_ShouldThrowArgumentNullException()
        {
            ...
            // Act
            var action = new Func<ForbiddenDetails>(() => new ForbiddenDetails(context));
