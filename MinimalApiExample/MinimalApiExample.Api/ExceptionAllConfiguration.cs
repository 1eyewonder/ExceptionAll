...
namespace MinimalApiExample.Api;

public class ExceptionAllConfiguration : IExceptionAllConfiguration
{
    /// <inheritdoc cref="IExceptionAllConfiguration.ErrorResponses"/>
    ...
    /// <inheritdoc cref="IExceptionAllConfiguration.ContextConfiguration"/>
